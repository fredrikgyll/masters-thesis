...
We will do this in to parts; Firstly, we will examine the various object detection frameworks and their use within microscopy.
...
In the first one, the pollen grain where labeled in the frame there they appeared sharpest, and ignored in all other images.
In the second dataset, the grains where labeled in all images throughout the sequence.
