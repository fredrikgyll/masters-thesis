...
%~\cite{gallardo_caballero_precise_2019} did not observe any real differences in performance between models trained with or without blurred images, but their method of using detections from multiple focal planes in each prediction, masks the effects that blur has on the model