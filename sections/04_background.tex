...
\done{clearly diff between detection, localization, and classification}
...
\done{Include a picture of this}
...
\info[inline]{Short about RNN}
\done[inline]{Add transfer learning\newline Add augmentations\newline In pollen section define normal search based system for pollen counting (p.43)}
