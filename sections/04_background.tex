...
A popular accuracy measure which derives from the precision and recall values if the \(F_1\) score, defined as,

\begin{align*}
  F_1=2\frac{\text{precision}\cdot\text{recall}}{\text{precision}+\text{recall}}
\end{align*}

This measures the balance between the two values and is useful in cases where precision and recall are equally important important performance measures.
...
\textit{Average Precision} is a single measure which quantifies this tradeoff by averaging the precision of a model at over all recall values.
