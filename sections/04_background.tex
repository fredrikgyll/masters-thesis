...
\begin{figure}[htb]
  ...
  Imaged with LM (a) and SEM (b). \textcite[98]{halbritter_methods_2018} / cropped and rearanged, licensed under CC BY 4.0 URL\@: \url{https://creativecommons.org/licenses/by/4.0/}}\label{fig:lm_and_sem}
\end{figure}
...
%Training an Object detection models follows the familiar scheme of \textit{mini-batch gradient decent} using \textit{backpropagation} to determine the gradient of each parameter.  
