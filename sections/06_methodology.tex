...
\info{Add axes to images\newline explain frequencies better}
% f_max from https://homepages.inf.ed.ac.uk/rbf/HIPR2/fourier.htm is good, add that bit
...
\end{figure}
\info{Show seperation of loc vs class parts in Figure}
...
\info{Confusing. Split sentence in two}
