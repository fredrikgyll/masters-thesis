...
Given that the data in this project exhibits this characteristic the standard NMS algorithm is replaced with a more modern version, Soft-NMS, introduced in~\cite{bodla2017softnms}.
