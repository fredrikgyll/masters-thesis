...
\begin{wrapfigure}{R}{0.2\textwidth}
  \centering
  \includegraphics[width=0.2\textwidth]{figs/method/default_boxes.png}
  \caption[Visualizing default boxes]{}\label{fig:defaults}
  %Visualization of 4 default boxes on a \(5\by 5 \) feature map.
\end{wrapfigure}
...
\info{Change this to something clearer, the center element is not responsible for anything}
...
\done{add explenation of \(g\) and regression}
